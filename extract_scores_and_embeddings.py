...
# Run once to score all pairs and cache to outputs/. Everything downstream reads from there.
# ~45-55 min on Colab T4 (800 pairs x 2 passes each).
# Zip before the session resets: shutil.make_archive("outputs_backup", "zip", "outputs")
